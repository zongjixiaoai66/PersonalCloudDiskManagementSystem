    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shuji !=null){
            ...
            BeanUtils.copyProperties( shuji , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(shuji.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody ShujiEntity shuji, HttpServletRequest request){
        ...
        if(false)
            ...
            shuji.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ShujiEntity> queryWrapper = new EntityWrapper<ShujiEntity>()
            ...
            .eq("yonghu_id", shuji.getYonghuId())
...
//            shuji.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ShujiEntity> queryWrapper = new EntityWrapper<ShujiEntity>()
            ...
            .eq("yonghu_id", shuji.getYonghuId())
            .eq("shuji_clicknum", shuji.getShujiClicknum())
            .eq("insert_time", new SimpleDateFormat("yyyy-MM-dd").format(shuji.getInsertTime()))
            ;
        ...
        if("".equals(shuji.getShujiFile()) || "null".equals(shuji.getShujiFile())){
                shuji.setShujiFile(null);
        }
        if(shujiEntity==null){
...
//                            shujiEntity.setShujiName(data.get(0));                    //书籍标题 要改的
//                            shujiEntity.setShujiTypes(Integer.valueOf(data.get(0)));   //书籍类别 要改的
//                            shujiEntity.setShujiPhoto("");//照片
//                            shujiEntity.setShujiFile(data.get(0));                    //书籍下载 要改的
//                            shujiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
