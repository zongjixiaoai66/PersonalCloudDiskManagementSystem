    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="博客标题" prop="bokeName">
                       <el-input v-model="ruleForm.bokeName"
                                 placeholder="博客标题" clearable  :readonly="ro.bokeName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="博客类型" prop="bokeTypes">
                        <el-select v-model="ruleForm.bokeTypes" :disabled="ro.bokeTypes" placeholder="请选择博客类型">
                            <el-option
                                v-for="(item,index) in bokeTypesOptions"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.bokePhoto" label="博客图片" prop="bokePhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.bokePhoto?ruleForm.bokePhoto:''"
                            @change="bokePhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="clicknum">
                       <el-input v-model="ruleForm.clicknum"
                                 placeholder="点击次数" clearable  :readonly="ro.clicknum"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="点击次数" prop="clicknum">
                           <el-input v-model="ruleForm.clicknum"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="博客内容" prop="bokeContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.bokeContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.bokeContent" label="博客内容" prop="bokeContent">
                            <span v-html="ruleForm.bokeContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   bokeTypes: [
                              { required: true, message: '博客类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   bokePhoto: [
                              { required: true, message: '博客图片不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=boke_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.bokeTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`boke/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.bokeCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            bokePhotoUploadChange(fileUrls){
                this.ruleForm.bokePhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
